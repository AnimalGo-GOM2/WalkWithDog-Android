...
public class WalkDiaryPetListAdapter extends BaseQuickAdapter<WalkModel, BaseViewHolder> {
  public WalkDiaryPetListAdapter(int layoutResId, @Nullable List<WalkModel> data) {
